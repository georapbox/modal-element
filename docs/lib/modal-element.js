...
`;var a=class i extends HTMLElement{static CLOSE_REQUEST_REASONS={CLOSE_BUTTON:"close-button",ESCAPE_KEY:"escape-key",BACKDROP_CLICK:"backdrop-click",EXTERNAL_INVOKER:"external-invoker"};#e=null;#n=null;#i=null;#o=null;constructor(){super(),this.shadowRoot||this.attachShadow({mode:"open"}).appendChild(r.content.cloneNode(!0)),this.shadowRoot&&(this.#e=this.shadowRoot.querySelector("dialog"),this.#n=this.shadowRoot.querySelector('slot[name="footer"]'),this.#i=this.shadowRoot.querySelector('slot[name="close"]'))}static get observedAttributes(){return["open","no-header","no-animations","no-close-button","close-label"]}attributeChangedCallback(e,t,o){if(this.#e!==null){if(e==="open"&&t!==o&&(this.open?(this.#e.classList.toggle("dialog--no-animations",this.noAnimations),this.#e.showModal(),this.dispatchEvent(new CustomEvent("me-open",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="hidden")):this.#e.close()),e==="no-header"&&t!==o){let n=this.#e.querySelector(".dialog__header");n!==null&&(n.hidden=this.noHeader)}if(e==="no-animations"&&t!==o&&this.#e.classList.toggle("dialog--no-animations",this.noAnimations),e==="no-close-button"&&t!==o){let n=this.#e.querySelector(".dialog__close");n!==null&&(n.hidden=this.noCloseButton)}e==="close-label"&&t!==o&&this.#r()}}connectedCallback(){this.#t("open"),this.#t("staticBackdrop"),this.#t("noHeader"),this.#t("noAnimations"),this.#t("noCloseButton"),this.#t("fullscreen"),this.#t("preserveOverflow"),this.#t("placement"),this.#t("closeLabel"),this.#e?.addEventListener("click",this.#h),this.#e?.addEventListener("close",this.#l),this.#e?.addEventListener("cancel",this.#d),this.#e?.querySelector('form[method="dialog"]')?.addEventListener("submit",this.#c),this.#n?.addEventListener("slotchange",this.#g),this.#i?.addEventListener("slotchange",this.#u),this.addEventListener("command",this.#m)}disconnectedCallback(){this.#e?.removeEventListener("click",this.#h),this.#e?.removeEventListener("close",this.#l),this.#e?.removeEventListener("cancel",this.#d),this.#e?.querySelector('form[method="dialog"]')?.removeEventListener("submit",this.#c),this.#n?.removeEventListener("slotchange",this.#g),this.#i?.removeEventListener("slotchange",this.#u),this.removeEventListener("command",this.#m),this.#o&&(this.#o?.cancel(),this.#o=null)}get open(){return this.hasAttribute("open")}set open(e){this.toggleAttribute("open",!!e)}get staticBackdrop(){return this.hasAttribute("static-backdrop")}set staticBackdrop(e){this.toggleAttribute("static-backdrop",!!e)}get noHeader(){return this.hasAttribute("no-header")}set noHeader(e){this.toggleAttribute("no-header",!!e)}get noAnimations(){return this.hasAttribute("no-animations")}set noAnimations(e){this.toggleAttribute("no-animations",!!e)}get noCloseButton(){return this.hasAttribute("no-close-button")}set noCloseButton(e){this.toggleAttribute("no-close-button",!!e)}get fullscreen(){return this.hasAttribute("fullscreen")}set fullscreen(e){this.toggleAttribute("fullscreen",!!e)}get preserveOverflow(){return this.hasAttribute("preserve-overflow")}set preserveOverflow(e){this.toggleAttribute("preserve-overflow",!!e)}get placement(){return this.getAttribute("placement")||"center"}set placement(e){this.setAttribute("placement",e!=null?e.toString():e)}get closeLabel(){return this.getAttribute("close-label")||"Close"}set closeLabel(e){this.setAttribute("close-label",e!=null?e.toString():e)}#r(){if(this.#e===null)return;let e=this.#e.querySelector(".dialog__close");if(e===null)return;(this.#i?.assignedElements()||[])?.some(n=>n.textContent?.replace(/\s/g,"")!=="")?e.removeAttribute("aria-label"):e.setAttribute("aria-label",this.closeLabel)}#s(){let e=window.matchMedia("(prefers-reduced-motion: reduce)").matches;if(this.noAnimations||e||this.#o)return;let o=this.#e;!o||typeof o.animate!="function"||(this.#o=o.animate(c,h),this.#o.finished.catch(()=>{}).finally(()=>{this.#o=null}))}#l=()=>{this.open=!1,this.dispatchEvent(new CustomEvent("me-close",{bubbles:!0,composed:!0,detail:{element:this}})),document.body&&!this.preserveOverflow&&(document.body.style.overflow="")};#d=e=>{let t=this.#a(i.CLOSE_REQUEST_REASONS.ESCAPE_KEY);this.dispatchEvent(t),t.defaultPrevented&&(e.preventDefault(),this.#s())};#c=e=>{let t=this.#a(i.CLOSE_REQUEST_REASONS.CLOSE_BUTTON);this.dispatchEvent(t),t.defaultPrevented&&(e.preventDefault(),this.#s())};#h=e=>{let{target:t,currentTarget:o}=e,n=t===o,l=t instanceof HTMLElement&&t.closest("[data-me-close]")!==null;if(!n&&!l)return;let d=n?i.CLOSE_REQUEST_REASONS.BACKDROP_CLICK:i.CLOSE_REQUEST_REASONS.EXTERNAL_INVOKER,s=this.#a(d);if(this.dispatchEvent(s),s.defaultPrevented||n&&this.staticBackdrop){this.#s();return}this.hide()};#m=e=>{switch(e.command){case"--me-open":{if(this.open)return;this.show();return}case"--me-close":{if(!this.open)return;let t=this.#a(i.CLOSE_REQUEST_REASONS.EXTERNAL_INVOKER);if(this.dispatchEvent(t),t.defaultPrevented){this.#s();return}this.hide();return}default:return}};#g=()=>{if(this.#e===null)return;let e=this.#e.querySelector(".dialog__footer");if(e===null)return;let t=this.#n?.assignedNodes(),o=t?t.length>0:!1;e.hidden=!o};#u=()=>{this.#r()};#a(e){return new CustomEvent("me-request-close",{bubbles:!0,composed:!0,cancelable:!0,detail:{reason:e,element:this}})}#t(e){let t=this;if(Object.prototype.hasOwnProperty.call(t,e)){let o=t[e];delete t[e],t[e]=o}}show(){this.open||(this.open=!0)}hide(){this.open&&(this.open=!1)}static defineCustomElement(e="modal-element"){typeof window<"u"&&!window.customElements.get(e)&&window.customElements.define(e,i)}};export{a as ModalElement};
